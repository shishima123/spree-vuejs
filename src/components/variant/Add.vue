        ...
        <div class="row border p-3">
          ...
          <div class="col-6 mt-3">
            <div class="form-group">
              ...
              <multiselect v-model="variant['size']"
                           id="size"
                           label="presentation"
                           placeholder=""
                           track-by="id"
            ...
            <div class="form-group">
              ...
              <multiselect v-model="variant['color']"
                           placeholder=""
                           id="color"
                           label="presentation"
                           track-by="id"
            ...
            <div class="form-group">
              ...
              <Select2 id="tax_category" :class="{ 'is-invalid':errors.option_value_ids}" v-model="variant.option_value_ids" :settings="{ theme: 'bootstrap4' }" :options="taxOptions" required/>
            </div>
          </div>
          <div class="col-6 mt-3">
            <div class="form-group">
...
export default {
  ...
  data () {
    return {
      ...
      sizeOptions: [],
      colorOptions: [],
      taxOptions: [{id: 0, text: 'None'}, {id: 1, text: 'Clothing'}, {id: 2, text: 'Food'}],
      error: false,
      errors: {}
    }
  },
  ...
  methods: {
    create () {
      ...
      delete variant.option_value_ids
      variant.size = variant.size.id
      variant.color = variant.color.id
      let url = this.$hostServer + `/api/v1/products/${this.$route.params.product_id}/variants?`
      url = this.generateUrlToCreateAndUpdate(url, variant, 'variant')
      url = url + `&variant[option_value_ids][]=${this.variant.option_value_ids}`
